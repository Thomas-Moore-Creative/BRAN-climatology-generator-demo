...
def main():
    ...
    for var in var_request_list:
        ...
        chunking_string = 'chunks_'+''.join(str(key) + str(value) for key, value in xarray_open_kwargs['chunks'].items())
        ard_file_ID = 'BRAN2020-daily-'+var+'-'+chunking_string+'-v25042024.zarr'
